...
- Urgent watch runs every 1 minute for high-signal connected-source findings such as urgent Gmail/support/emergency messages. It should dedupe alerts and stay silent when nothing new matters.
